from src.app.dtos import PromptResponse, SoftDeletePromptCommand
...
class SoftDeletePromptUseCase:
    def __init__(self, uow: UnitOfWork, publisher: EventPublisher):
        self._uow = uow
        self._publisher = publisher

    async def execute(self, command: SoftDeletePromptCommand) -> PromptResponse:
